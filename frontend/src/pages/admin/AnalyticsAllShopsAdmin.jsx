...
import { getAllShopsAnalytics } from "../../services/adminService";
...
const AnalyticsAllShopsAdmin = () => {
    ...
    const loadAnalytics = async () => {
        ...
        setLoading(true);
        try {
            const data = await getAllShopsAnalytics(dateFrom, dateTo);
            setAnalytics(data);
        } catch (e) {
...
export default AnalyticsAllShopsAdmin;