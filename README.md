...
Поле unit_price сохраняет стоимость товара, в которую также входит стоимость выбранных дополнительных опций (ProductAttributeOption),
актуальную на момент заказа. Если в таблице products изменяется стоимость товара, или в таблице product_attribute_options изменяется поле extra_price, 
это не меняет сохранённое значение в поле unit_price.
